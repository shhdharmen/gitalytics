...
export interface UserDataFragment {
  avatarUrl: any;
  bio?: Maybe<string>;
  name?: Maybe<string>;
  url: any;
...
export interface ContributionsCollectionDataFragment {
  ...
  repositoryContributions: {
    edges?: Maybe<
      Array<
        Maybe<{
          node?: Maybe<{
            repository: { isFork: boolean; stargazerCount: number; forkCount: number };
          }>;
        }>
      >
    >;
  ...
  issueContributions: {
    edges?: Maybe<Array<Maybe<{ node?: Maybe<{ issue: { closed: boolean } }> }>>>;
  };
  pullRequestContributions: {
    edges?: Maybe<
      Array<
        Maybe<{
          node?: Maybe<{ pullRequest: { closed: boolean; merged: boolean; changedFiles: number } }>;
        }>
      >
    >;
  };
...
export interface TotalContributionsQuery {
  user?: Maybe<{ contributionsCollection: ContributionsCollectionDataFragment } & UserDataFragment>;
...
export const TotalContributionsDocument = gql`
  ...
  ${UserDataFragmentDoc}
  ${ContributionsCollectionDataFragmentDoc}
`;
